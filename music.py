...
if __name__ == "__main__":
    ...
    segments = [
        [(None, 1)],
        to_seq([("A#", 1/4), ("C",  1/4), ("D",  1/2)], root),
        to_seq([("D#", 1/4), ("C#", 1/4), ("F",  1/2)], root),
        to_seq([("G",  1/4), ("B",  3/8), ("B",  1/8), ("A",  1/4)], root),
        to_seq([("E",  1/4), ("F#", 3/8), ("F#", 1/8), ("G#", 1/4)], root),
        to_seq([("A#", 1/4), ("C",  1/4), ("C",  1/4), ("D",  1/4)], root),
        to_seq([("G",  1/4), ("G",  1/4), ("B",  1/4), ("A",  1/4)], root),
        to_seq([("E",  1/4), ("F#", 1/4), ("F#", 1/4), ("G#", 1/4)], root),
        to_seq([("D#", 1/4), ("D#", 1/4), ("C#", 1/4), ("E",  1/4)], root),
    ]
    s_weights = [
        20,
        20,
